...
| Build | Gradle Kotlin DSL + version catalog. AGP 9.3.1 / Gradle 9.6.1 / Kotlin 2.4.10 / Hilt 2.60.1; AGP built-in Kotlin + modern DSL |
...
- **`ci.yml`** (push/PR to `main`): `./gradlew assembleDebug test --stacktrace`.
